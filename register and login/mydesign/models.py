...
class Movie(models.Model):
    name = models.CharField('视频名称', max_length=255)  # 视频名称
    country = models.CharField('国家/地区', max_length=255)  # 国家/地区
    release_time = models.DateField('上映时间',max_length=255)  # 上映时间
    director = models.CharField('导演', max_length=255)  # 导演
    # lead_role = models.CharField(max_length=255)  # 主演
    length = models.CharField('片长', max_length=255)  # 片长
    imdb_link = models.CharField('Imdb链接', max_length=255)  # Imdb链接
    mark = models.FloatField('评分', max_length=255)  # 评分
    cover_link = models.ImageField('封面图片',max_length=255)  # 封面图片地址
    summary = models.TextField('剧情简介',max_length=999)  # 剧情简介
